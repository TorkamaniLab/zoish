...
test_files = [
    "tests/test_shap_compared_with_other_selector_binery_classification.py",
    "tests/test_shap_compared_with_other_selector_multi_classification.py",
    "tests/test_shap_compared_with_other_selector_regression.py",
    "tests/test_shap_feature_selector_with_n_feature.py",
    "tests/test_shap_feature_selector_with_threshold.py",
    "tests/test_zoish.py",
]
