...
class SelectByShufflingPlotFeatures(PlotFeatures):
    """Class for creating plots for select by fhuffling feature selector.
    check this :
    https://feature-engine.readthedocs.io/en/latest/user_guide/selection/SelectByShuffling.html

    Parameters
    ----------
    feature_selector : object
        It is an instance of SelectByShufflingFeatureSelector. Before using SelectByShufflingPlotFeatures
        SelectByShufflingFeatureSelector should be implemented.
    ...
    Notes
    -----
    This class is not stand by itself. First SelectByShufflingPlotFeatures should be
    implemented.
...
class SelectByShufflingFeatureSelector(FeatureSelector):
    """
    Feature selector class based on  Select By Shuffling.
    ...
    Notes
    -----
    This class is not stand by itself. First SelectByShufflingFeatureSelector should be
    implemented.
    """
    ...
    def fit(self, X, y, *args, **kwargs):
        ...
        if self.bst is None:
            ...
            self.feature_object = SelectByShuffling(
    ...
    class SelectByShufflingFeatureSelectorFactory:
        """Class factory for SelectByShufflingSelector
        ...
        method: str
            ...
            check this: ``https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GridSearchCV.html``
        feature_selector : object
            An instance of type SelectByShufflingFeatureSelector.

        Methods
        -------
        set_model_params(*args,**kwargs)
            A method to set model parameters.
        set_select_by_shuffling_params(*args,**kwargs)
            A method to set select by shuffling feature parameters.
        ...
        plot_features_all(*args,**kwargs)
            A method that uses SelectByShufflingPlotFeatures to plot different plots.
        get_info_of_features_and_grades()
            A method that uses SelectByShufflingPlotFeatures to get information of selected features.
        ...
        def set_select_by_shuffling_params(
            self,
            cv,
            variables,
            confirm_variables,
        ...
        def plot_features_all(
            ...
            select_by_shuffling_plot_features = SelectByShufflingPlotFeatures(
                feature_selector=self.feature_selector,
                path_to_save_plot=path_to_save_plot,
            )
            if self.feature_selector is not None:
                select_by_shuffling_plot_features.plot_features()
        ...
        def get_info_of_features_and_grades(
            ...
            """A method that uses SelectByShufflingPlotFeatures to get a
        ...
        def get_list_of_features(
            ...
            """A method that uses SelectByShufflingPlotFeatures to get a list of selected features."""

            select_by_shuffling_plot_features = SelectByShufflingPlotFeatures(
                feature_selector=self.feature_selector,
                path_to_save_plot=None,
            )
            if select_by_shuffling_plot_features.get_list_of_features() is not None:
                return select_by_shuffling_plot_features.get_list_of_features()
            else:
                return None
