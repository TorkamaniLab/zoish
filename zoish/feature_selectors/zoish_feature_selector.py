...
class OptunaShapFeatureSelector(BaseEstimator, TransformerMixin):
    ...
    def list_of_obligatory_features_that_must_be_in_model(self):
        logging.info("Getting value for list_of_obligatory_features_that_must_be_in_model")
    ...
    def list_of_obligatory_features_that_must_be_in_model(self, value):
        logging.info("Setting value for list_of_obligatory_features_that_must_be_in_model")
    ...
    def fit(self, X, y):
        ...
        if self.estimator.__class__.__name__ is None:
            ...
            if self.save_shap_summary_plot:
                ...
                shap.summary_plot(shap_values.values, X, max_display=self.n_features,show=False)
                plt.tight_layout()
    ...
    def get_fig_object(self):
        ...
        if self.shap_fig is None:
            raise ValueError(
                "The fig object is empty :( "
            )
        return self.shap_fig

    

class GridSearchCVShapFeatureSelector(BaseEstimator, TransformerMixin):
    """
        Feature Selector class using shap values and Grid Search. It is extended from scikit-learn
        BaseEstimator and TransformerMixin. 
    ...
    ...
    def grid_search_n_jobs(self):
        logging.info("Getting value for grid_search_n_jobs")
        return self._grid_search_n_jobs

    @grid_search_n_jobs.setter
    def grid_search_n_jobs(self, value):
        logging.info("Setting value for grid_search_n_jobs")
        self._grid_search_n_jobs = value
