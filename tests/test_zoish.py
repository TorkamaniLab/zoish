...
def setup_factories(datasets):
    ...
    # a test case of type hardware regression optimization by optuna
    ...
    # a test case of type hardware regression optimization by random search
    ...
    # a test case of type hardware regression optimization by grid search
    ...
    # a test case of type audiology classification optimization by optuna
    ...
    # a test case of type audiology classification optimization by random search
    ...
    # a test case of type audiology classification optimization by grid search
