...
def setup_factories(datasets):
    ...
    # a test case of type audiology classification optimization by tunegridsearch
    audiology_cls_gridtunesearch_1 = case_creator(
        threshold=0.0005,
        scoring="f1_macro",
        dataset="audiology",
    ...
    # a test case of type audiology classification optimization by tunegridsearch
    audiology_cls_gridtunesearch_2 = case_creator(
        threshold=0.0005,
        scoring="f1_micro",
        dataset="audiology",
    ...
    shap_audiology_cls_tunegridsearch = audiology_cls_gridtunesearch_1.get_shap_selector_tunegridsearch()
    single_audiology_cls_tunegridsearch = audiology_cls_gridtunesearch_1.get_single_selector_tunegridsearch()
    shuffling_audiology_cls_tunegridsearch = audiology_cls_gridtunesearch_2.get_shuffling_selector_tunegridsearch()
    addition_audiology_cls_tunegridsearch = audiology_cls_gridtunesearch_2.get_addition_selector_tunegridsearch()
    elimination_audiology_cls_tunegridsearch = audiology_cls_gridtunesearch_2.get_elimination_selector_tunegridsearch()

    # A list of all cases for problem type audiology
    audiology_list = [
        

        shap_audiology_cls_tunegridsearch,
        single_audiology_cls_tunegridsearch,
        shuffling_audiology_cls_tunegridsearch,
        addition_audiology_cls_tunegridsearch,
        elimination_audiology_cls_tunegridsearch,
