...
def setup_factories(datasets):
    ...
    shap_adult_cls_tunegridsearch = adult_cls_gridtunesearch_1.get_shap_selector_tunegridsearch()
    single_adult_cls_tunegridsearch = adult_cls_gridtunesearch_1.get_single_selector_tunegridsearch()
    shuffling_adult_cls_tunegridsearch = adult_cls_gridtunesearch_2.get_shuffling_selector_tunegridsearch()
    addition_adult_cls_tunegridsearch = adult_cls_gridtunesearch_2.get_addition_selector_tunegridsearch()
    elimination_adult_cls_tunegridsearch = adult_cls_gridtunesearch_2.get_elimination_selector_tunegridsearch()

    # A list of all cases for problem type adult
    adult_list = [
        

        shap_adult_cls_tunegridsearch,
        single_adult_cls_tunegridsearch,
        shuffling_adult_cls_tunegridsearch,
        addition_adult_cls_tunegridsearch,
        elimination_adult_cls_tunegridsearch,
