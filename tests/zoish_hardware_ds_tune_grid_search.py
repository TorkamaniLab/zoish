...
def setup_factories(datasets):
    ...
    # a test case of type hardware classification optimization by tunegridsearch
    hardware_cls_gridtunesearch_1 = case_creator(
        threshold=0.0005,
        scoring="r2",
        dataset="hardware",
    ...
    # a test case of type hardware classification optimization by tunegridsearch
    hardware_cls_gridtunesearch_2 = case_creator(
        threshold=0.0005,
    ...
    # adult and tunegridsearch
    shap_hardware_cls_tunegridsearch = hardware_cls_gridtunesearch_1.get_shap_selector_tunegridsearch()
    single_hardware_cls_tunegridsearch = hardware_cls_gridtunesearch_1.get_single_selector_tunegridsearch()
    shuffling_hardware_cls_tunegridsearch = hardware_cls_gridtunesearch_2.get_shuffling_selector_tunegridsearch()
    addition_hardware_cls_tunegridsearch = hardware_cls_gridtunesearch_2.get_addition_selector_tunegridsearch()
    elimination_hardware_cls_tunegridsearch = hardware_cls_gridtunesearch_2.get_elimination_selector_tunegridsearch()

    # A list of all cases for problem type hardware
    hardware_list = [
       

        shap_hardware_cls_tunegridsearch,
        single_hardware_cls_tunegridsearch,
        shuffling_hardware_cls_tunegridsearch,
        addition_hardware_cls_tunegridsearch,
        elimination_hardware_cls_tunegridsearch,
...
def test_hardware(datasets, setup_factories):
    """
    A test function for all cases of hardware.
    """
