...
def setup_factories(datasets):
    ...
    # a test case of type hardware classification optimization by tunesearch
    hardware_cls_tunesearch_1 = case_creator(
        threshold=0.0005,
        scoring='r2',
        dataset="hardware",
    ...
    # a test case of type hardware classification optimization by tunesearch
    hardware_cls_tunesearch_2 = case_creator(
        threshold=0.0005,
        scoring='r2',
        dataset="hardware",
        estimator=xgboost.XGBRegressor(),
    ...
    shap_hardware_cls_tunesearch = hardware_cls_tunesearch_1.get_shap_selector_tunesearch()
    single_hardware_cls_tunesearch = hardware_cls_tunesearch_1.get_single_selector_tunesearch()
    shuffling_hardware_cls_tunesearch = hardware_cls_tunesearch_2.get_shuffling_selector_tunesearch()
    addition_hardware_cls_tunesearch = hardware_cls_tunesearch_2.get_addition_selector_tunesearch()
    elimination_hardware_cls_tunesearch = hardware_cls_tunesearch_2.get_elimination_selector_tunesearch()
    
    # A list of all cases for problem type hardware
    hardware_list = [
       
        shap_hardware_cls_tunesearch,
        single_hardware_cls_tunesearch,
        shuffling_hardware_cls_tunesearch,
        addition_hardware_cls_tunesearch,
        elimination_hardware_cls_tunesearch,
    ]
